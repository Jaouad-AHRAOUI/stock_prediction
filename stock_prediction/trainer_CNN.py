...
#---Load test data to predict a given period
def prediction_return_CNN(start='2020-01-03', stop='2020-12-31'):
    ...
    def load_predict_data(company, start_date='2020-01-03', end_date='2020-12-31', len_=20):
